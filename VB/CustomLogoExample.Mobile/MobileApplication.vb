...
Namespace CustomLogoExample.Mobile
    ...
    Partial Public Class CustomLogoExampleMobileApplication
...
#End If
        ...
        End Function
        Private Sub CustomLogoExampleMobileApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
