...
Namespace CustomizeTemplateContentExample.Module
    ...
    Public NotInheritable Partial Class CustomizeTemplateContentExampleModule ' http://documentation.devexpress.com/#Xaf/clsDevExpressExpressAppModuleBasetopic
        Inherits ModuleBase
