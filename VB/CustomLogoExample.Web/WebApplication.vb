...
Namespace CustomLogoExample.Web
    ...
    Partial Public Class CustomLogoExampleAspNetApplication
        ...
        Private Sub CustomLogoExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
